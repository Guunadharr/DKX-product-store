...
//     BTAppContextSwitcher.setReturnURLScheme("com.nvg.dhanush.dk.meetair.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.nvg.dhanush.dk.meetair.braintree") == .orderedSame {
